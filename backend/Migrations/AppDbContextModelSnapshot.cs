...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Model.BankAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("backend.Model.Order", b =>
                {
                    ...
                    b.Property<int>("FailedReleaseAttempts")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("backend.Model.PayoutQueue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Status", "ScheduledPayoutDate");

                    b.ToTable("PayoutQueue");
                });
            ...
            modelBuilder.Entity("backend.Model.VoucherRedemption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("VoucherHashedPin")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("VoucherMasked")
                        .IsRequired()
                        .HasMaxLength(20)
                    ...
                    b.HasIndex("VoucherHashedPin")
                        .IsUnique();

                    b.ToTable("VoucherRedemptions");
                });

            modelBuilder.Entity("backend.Model.Wallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("backend.Model.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("backend.Model.Order", b =>
                {
                    b.HasOne("backend.Model.User", "Buyer")
            ...
            modelBuilder.Entity("backend.Model.VoucherRedemption", b =>
                {
                    b.HasOne("backend.Model.WalletTransaction", "Transaction")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Model.WalletTransaction", b =>
                {
                    ...
                    b.HasOne("backend.Model.Wallet", "Wallet")
